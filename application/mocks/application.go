...
import (
	...
	application "github.com/guiluizmaia/fc2-arquitetura-hexagonal-go/application"
)
...
func (mr *MockIProductServiceMockRecorder) Enable(product interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Enabled", reflect.TypeOf((*MockIProductService)(nil).Enable), product)
}
